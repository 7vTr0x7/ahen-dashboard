...
function PageEight() {
  return (
    <div className="">
      ...
      <div>
        <h3 className="text-lg font-bold text-red-600 mb-2">Notes *</h3>
        <p className="text-sm font-semibold text-black-600  mb-5">
          If you don't have an idea about this, just skip this
        </p>
      </div>
    </div>
  );
