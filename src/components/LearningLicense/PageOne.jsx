          ...
          if (step === 1) {
            return (
              <div>
                ...
                <button className="mb-2 rounded bg-green-600 px-6 py-2 text-white transition hover:bg-green-700">
                  Open Pdf
                </button>
              </div>
            );
              ...
              <div className="">
                <div className="">
                  ...
                  <div className="mb-7">
                    ...
                    <p className="mb-3 text-base font-light text-gray-700">
            ...
            return (
              <div className="">
                ...
                <div>
                  ...
                  <div>
                    <button className="bg-black mb-5 rounded-lg px-6 py-2 text-white transition hover:bg-gray-800">
