      ...
      <div className="rounded-lg w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p>
              Name: <span className="font-semibold">Sahil</span>
            </p>
            <p>
              Mobile No: <span className="font-semibold">9372829018</span>
            </p>
            <p>
              Email:{" "}
              <span className="font-semibold">sahilthandle824@gmail.com</span>
            </p>
            <p>
